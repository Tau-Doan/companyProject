<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      <el-form-item label="名称" prop="name">
        <el-input
          ...
          placeholder="请输入群产品类型名称"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="VIP等级" prop="type">
        <el-select v-model="queryParams.level" placeholder="请选择vip等级" clearable size="small">
          <el-option
            v-for="unit in levelOptions"
            :key="unit.dictValue"
    ...
    <el-table v-loading="loading" :data="productList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="群数量" align="center" prop="value"/>
      <el-table-column label="VIP等级" :formatter="levelFormat" align="center" prop="value"/>
  ...
  export default {
    ...
    methods: {
      ...
      async loadStatusDict() {
        const response = await this.getDicts("product_group_type_status");
